    ...
    <header>
      <div className="header-content">
        <div className="header-content-inner">
          ...
          <p><a href="https://cfp.capitoledulibre.org/cdl-2024/cfp" className="btn btn-primary btn-xl page-scroll">Proposez une conférence, un atelier, un stand jusqu'au 31 juillet 23h59</a></p>
