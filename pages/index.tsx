          ...
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul className="nav navbar-nav navbar-right">
                ...
                <li>
                  <a className="page-scroll" href="/code-of-conduct/#code-of-conduct">Code de Conduite</a>
                </li>
                <li>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-8 col-lg-offset-2 text-center">
                ...
                <a href="#event" className="page-scroll btn btn-default btn-xl sr-button">Découvrez les détails de l'événement</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="event">
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 text-center">
                <div className="service-box">
                  <i className="fa fa-4x fa-bullhorn text-primary sr-icons"></i>
                  <h3>Conférences</h3>
                  <p className="text-muted">Autour de thématiques techniques: C++, développement Web, embarqué, DevOps; de logiciels libres de création graphique et multimédia; de jeux libres; d'enjeux du logiciel libre dans la société et des communautés.<br /><a href="https://2019.capitoledulibre.org/programme/#schedule">Retrouvez les conférences de l'édition 2019</a></p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 text-center">
                <div className="service-box">
                  <i className="fa fa-4x fa-university text-primary sr-icons"></i>
                  <h3>Ateliers</h3>
                  <p className="text-muted">Venez découvrir le logiciel libre lors d'ateliers avec des expert⋅e⋅s pour vous assister.<br /><a href="https://2019.capitoledulibre.org/programme/#schedule">Retrouvez les ateliers de l'édition 2019</a></p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 text-center">
                <div className="service-box">
                  <i className="fa fa-4x fa-life-ring text-primary sr-icons"></i>
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 text-center">
                <div className="service-box">
                  <i className="fa fa-4x fa-child text-primary sr-icons"></i>
              ...
              <div className="col-lg-3 col-md-6 text-center">
                <div className="service-box">
                  <i className="fa fa-4x fa-glass-martini text-primary sr-icons"></i>
                  <h3>Cocktail</h3>
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 text-center">
                <div className="service-box">
                  <i className="fas fa-4x fa-money-check-alt text-primary sr-icons"></i>
                  <h3>Entrée</h3>
              ...
              <div className="col-lg-3 col-md-6 text-center">
                <div className="service-box">
                  <i className="fa fa-4x fa-gamepad text-primary sr-icons"></i>
                  <h3>LAN Party</h3>
                  <p className="text-muted">Venez jouer avec vos ami(e)s à des jeux <a href="img/jeux.pdf">libres</a></p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 text-center">
                <div className="service-box">
                  <i className="fa fa-4x fa-truck text-primary sr-icons"></i>
                  <h3>Food Truck</h3>
              ...
              <div className="col-lg-3 col-md-6 text-center">
                <div className="service-box">
                  <i className="fa fa-4x fa-shopping-cart text-primary sr-icons"></i>
