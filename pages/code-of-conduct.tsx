            ...
            <section id="code-of-conduct">
                <div className="container">
                    <div className="row">
                        ...
                        <p>Toulibre souhaite éviter tout type de discrimination, que ce soit sur le sexe, l’orientation sexuelle, le handicap, l’apparence physique, l’origine ou la religion, et sous quelque forme que ce soit (parole, image, texte et autre). Bien évidemment, ceci n’est pas une liste exhaustive.</p>

                        <p>Bien que Toulibre ait pour but la promotion du libre dans le monde francophone, l’association s’engage à accueillir chacun, quelle que soit son langage de programmation ou sa langue maternelle.</p>

                        <p>Toulibre attend de ses membres un langage et un style adaptés à une audience variée. Les allusions sexuelles ou à caractère raciste ne sont en aucun cas tolérées, quel que soit leur support.</p>
